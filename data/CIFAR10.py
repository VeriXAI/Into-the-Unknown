...
def load_CIFAR_10(data_train_model: DataSpec, data_test_model: DataSpec, data_train_monitor: DataSpec,
    ...
    cifar10_dataset_folder_path = DATA_PATH + "cifar-10-python/cifar-10-batches-py"
    ...
    if adversarial_data_suffix is not None:
        with open(cifar10_dataset_folder_path + "/adversarial{}".format(adversarial_data_suffix), mode='rb') as file:
